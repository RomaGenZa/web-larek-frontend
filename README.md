...
- `isPaymentValid: TPaymentValidation` хранит состояние валидности введенных данных об оплате. 
- `isContactValid: TContactValidation` хранит состояние валидности введенных контактных данных. 
...
- `validate(data: TPaymentValidation): void` обновляет состояние кнопки "Далее", обновляет сообщение об ошибке.  
...
- `validate(data: TContactValidation): void` управление состоянием кнопки отправки (активация/деактивация) в зависимости от валидности введенных данных и устанавливает сообщение об ошибке если имеется.
